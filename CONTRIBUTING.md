...
- **Sync-status wording.** `components/sync-status.tsx` mirrors time.is phrasing (_"Your clock is 0.4 seconds behind."_, _"Accuracy of synchronization was ±0.023 seconds."_). Preserve that style.
